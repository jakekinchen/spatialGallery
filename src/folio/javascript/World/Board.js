...
export default class Board
{
    ...
    setAddMediaLabel() {
        // Set up
        this.planeMesh.area.addMediaLabel = {}
        ...
        loader.load('fonts/comic_neue.json', (font) => {
            ...
            this.planeMesh.area.addMediaLabel.material = new THREE.MeshBasicMaterial({ 
                transparent: false, 
                depthWrite: false, 
                // make the color light blue
                color: 0xffffff
            });
            this.planeMesh.area.addMediaLabel.material.opacity = 0.5;
    
            this.planeMesh.area.addMediaLabel.mesh = new THREE.Mesh(
                geometry, 
                this.planeMesh.area.addMediaLabel.material
            );
            this.planeMesh.area.addMediaLabel.mesh.position.set(this.x-2.35, this.y-3.28, 0);
            this.planeMesh.area.addMediaLabel.mesh.matrixAutoUpdate = false;
            this.planeMesh.area.addMediaLabel.mesh.updateMatrix();
    
            this.container.add(this.planeMesh.area.addMediaLabel.mesh);
        });
    }
